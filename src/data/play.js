...
export const playCategories = [
  ...
  { id: 'arcade', label: 'Arcade', instantPlay: [{ id: 'neon-runner', name: 'Neon Runner', image: '/assets/games/neon-runner.png', description: 'Endless speedrun challenge.', dailyMission: 'Run 3 minutes', points: 70, recommended: true, popular: true, fallback: '🕹️' }], apps: [{ id: 'subway-surfers', name: 'Subway Surfers', packageName: 'com.kiloo.subwaysurf', playStoreUrl: 'https://play.google.com/store/apps/details?id=com.kiloo.subwaysurf', image: '/assets/apps/subway-surfers.png', rating: '4.5', downloads: '1B+', points: 180, fallback: '🏃' }] },
