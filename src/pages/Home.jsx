...
export default function Home({ onNavigate }) {
  ...
  return (
    <section className="space-y-6">
      <header
        className={`sticky top-[116px] z-20 overflow-hidden rounded-2xl border border-white/10 bg-[#0B0B0B] p-4 shadow-md shadow-black/30 transition-all duration-300 ${isProfileCompact ? 'py-3' : 'py-4'}`}
      >
