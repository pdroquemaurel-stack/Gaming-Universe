const profile = {
  ...
  externalConnections: ['League of Legends', 'Fortnite', 'Free Fire', 'EA SPORTS FC'],
};
    ...
    <section className="space-y-5">
      ...
      <article className="card-base space-y-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <p className="text-xs text-zinc-300">QR code placeholder pour ajouter ce joueur en ami.</p>
        </div>
      ...
      <article className="card-base space-y-3">
        ...
        {profile.externalConnections.map((item) => (
          <div key={item} className="flex items-center justify-between rounded-xl border border-white/10 bg-black/30 p-3">
            ...
            <button type="button" className="rounded-md border border-orangeBrand px-3 py-2 text-xs font-semibold text-orangeBrand">Connect</button>
          </div>
        ))}
      </article>
    </section>
